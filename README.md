...
### [Помощник выполнения домашнего задания на GetCource + Telegram-бот для выдачи HWID-лицензий](https://github.com/destraa2/Keys-GC-Helper)
### [Telegram-bot для покупки токена и привязки hwid](https://t.me/paygetcource_bot)
